...
protected:
    ...
    */
    ...
    struct BusesProperties
    {
        ...
        [[nodiscard]] BusesProperties withIndexedOutputs (const String& name, int numOutputs, const AudioChannelSet& defaultLayout, bool isActivatedByDefault = true) const;
    };
